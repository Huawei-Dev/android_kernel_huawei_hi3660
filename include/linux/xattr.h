...
int __vfs_setxattr_locked(struct vfsmount *mnt, struct dentry *, const char *, const void *, size_t, int, struct inode **);
int vfs_setxattr(struct vfsmount *mnt, struct dentry *, const char *, const void *, size_t, int);
int __vfs_removexattr(struct dentry *, const char *);
int __vfs_removexattr_locked(struct vfsmount *mnt, struct dentry *, const char *, struct inode **);
